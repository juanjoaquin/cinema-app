...
export const Register = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await axios.post(import.meta.env.VITE_AUTH_REGISTER, formData);
            ...
            setError('Error. Try again please.');
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="w-full max-w-md p-8 space-y-8  rounded-xl shadow-2xl mx-auto">
            <div className="text-center">
                ...
                <p className="mt-2 text-sm text-gray-400">Sign up to get started with our service</p>
            </div>

            <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                <div className="space-y-5">
                    <div>
                        <label htmlFor="name" className="text-sm font-medium text-indigo-400 flex items-center gap-2">
                ...
                <div className="flex items-center justify-center">
                    <span className="text-sm text-gray-500">
                        ...
                        <Link to="/auth/login" className="font-medium text-indigo-500 hover:text-indigo-400 transition-colors duration-200">
                            Sign in
                        </Link>
                    </span>
                </div>
